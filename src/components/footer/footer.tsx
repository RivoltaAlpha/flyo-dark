...
export const Footer: React.FC = () => (
  <footer className="bg-gray-800 py-16 px-6">
    <div className="max-w-6xl mx-auto">
      <img src="./images/logo.svg" alt="Fylo logo" className="h-8 mb-8" />
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div>
          <p className="flex items-start mb-4">
            <img src="./images/icon-location.svg" alt="Location" className="mr-4 mt-1" />
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua
          </p>
        </div>
        <div>
          <p className="flex items-center mb-4">
            <img src="./images/icon-phone.svg" alt="Phone" className="mr-4" />
            +1-543-123-4567
          </p>
          <p className="flex items-center">
            <img src="./images/icon-email.svg" alt="Email" className="mr-4" />
            example@fylo.com
          </p>
        </div>
        <div>
